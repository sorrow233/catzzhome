const translations = {
  zh: {
    ...
    theme_hint: '打开设置', bookmark_actions: '快捷方式操作', empty_icon: '站点', offline: '当前离线，显示本地设置。',
    search_placeholder: '搜索、输入网址或执行命令', search_hint: '输入 / 查看命令，@yt 等指定站点搜索', settings: '设置', today: '今日', focus: '专注', notes: '快速记录', calendar: '日历',
    ...
    command_unknown: '未知命令。可使用 /focus、/note、/weather、/settings 或 /export。', backup_invalid: '备份文件无效。', imported: '导入完成', no_events: '未来七天没有日程', next_event: '下一个日程'
  },
  'zh-TW': {
    ...
    theme_hint: '開啟設定', bookmark_actions: '快速方式操作', empty_icon: '網站', offline: '目前離線，顯示本機設定。',
    search_placeholder: '搜尋、輸入網址或執行指令', search_hint: '輸入 / 查看指令，@yt 等指定網站搜尋', settings: '設定', today: '今日', focus: '專注', notes: '快速記錄', calendar: '行事曆',
    ...
    command_unknown: '未知指令。可使用 /focus、/note、/weather、/settings 或 /export。', backup_invalid: '備份檔案無效。', imported: '匯入完成', no_events: '未來七天沒有行程', next_event: '下一個行程'
  },
  en: {
    ...
    theme_hint: 'Open settings', bookmark_actions: 'Shortcut actions', empty_icon: 'Site', offline: 'You are offline. Local settings are shown.',
    search_placeholder: 'Search, enter a URL, or run a command', search_hint: 'Type / for commands or @yt to search a site', settings: 'Settings', today: 'Today', focus: 'Focus', notes: 'Quick notes', calendar: 'Calendar',
    ...
    command_unknown: 'Unknown command. Try /focus, /note, /weather, /settings, or /export.', backup_invalid: 'This backup is not valid.', imported: 'Import complete', no_events: 'No events in the next seven days', next_event: 'Next event'
  },
  ja: {
    ...
    theme_hint: '設定を開く', bookmark_actions: 'ショートカット操作', empty_icon: 'サイト', offline: 'オフラインです。ローカル設定を表示しています。',
    search_placeholder: '検索、URL入力、コマンド実行', search_hint: '/ でコマンド、@yt でサイト検索', settings: '設定', today: '今日', focus: '集中', notes: 'クイックメモ', calendar: 'カレンダー',
    ...
    command_unknown: '不明なコマンドです。/focus、/note、/weather、/settings、/export が使えます。', backup_invalid: 'バックアップが無効です。', imported: '読み込み完了', no_events: '今後7日間の予定はありません', next_event: '次の予定'
  },
  ko: {
    ...
    theme_hint: '설정 열기', bookmark_actions: '바로가기 작업', empty_icon: '사이트', offline: '오프라인 상태입니다. 로컬 설정을 표시합니다.',
    search_placeholder: '검색, URL 입력 또는 명령 실행', search_hint: '/ 명령 또는 @yt 사이트 검색', settings: '설정', today: '오늘', focus: '집중', notes: '빠른 메모', calendar: '캘린더',
    ...
    command_unknown: '알 수 없는 명령입니다. /focus, /note, /weather, /settings, /export를 사용할 수 있습니다.', backup_invalid: '유효하지 않은 백업입니다.', imported: '가져오기 완료', no_events: '앞으로 7일간 일정이 없습니다', next_event: '다음 일정'
  }
};
